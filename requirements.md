...
- [ ] 새로운 내역 박스
  ...
  - [ ] 금액
    ...
    - [ ] 금액 입력값은 세자리마다 쉼표가 찍힌다.
      - [ ] 금액 입력할 때 숫자, 화살표(좌,우), 백스페이스를 제외하고 모두 동작을 막는다.
      - [ ] 금액 입력창이 blur 됐을 때 store에 금액을 저장하고 쉼표를 찍는다.
      - [ ] 금액 입력창이 focus 됐을 때 저장된 금액을 금액 입력창에 띄운다.
  - [x] 내용
